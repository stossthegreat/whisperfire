...
class WFColors {
  ...
  // Text colors
  static const Color textPrimary = Color(0xFF111827); // near-black (was near-white)
  static const Color textSecondary = Color(0xFF374151); // gray-700 (was gray-300)
  static const Color textTertiary = Color(0xFF6B7280); // gray-500 (was gray-400)
  static const Color textMuted = Color(0xFF9CA3AF); // gray-400 (was gray-500)

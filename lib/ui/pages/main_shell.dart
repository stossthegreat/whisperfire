...
class _BottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (currentLocation) {
      case '/lessons': selectedIndex = 0; break;
      case '/mentors': selectedIndex = 1; break;
      case '/analyze': selectedIndex = 2; break;
      case '/profile': selectedIndex = 3; break;
      case '/settings': selectedIndex = 4; break;
    }
      ...
      child: SafeArea(
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              _NavItem(icon: Icons.school_outlined, activeIcon: Icons.school, label: 'Lessons', 
                      isActive: selectedIndex == 0, onTap: () => context.go('/lessons')),
              _NavItem(icon: Icons.psychology_outlined, activeIcon: Icons.psychology, label: 'Mentors', 
                      isActive: selectedIndex == 1, onTap: () => context.go('/mentors')),
              _NavItem(icon: Icons.visibility_outlined, activeIcon: Icons.visibility, label: 'Analyze', 
                      isActive: selectedIndex == 2, onTap: () => context.go('/analyze')),
              _NavItem(icon: Icons.person_outline, activeIcon: Icons.person, label: 'Profile', 
                      isActive: selectedIndex == 3, onTap: () => context.go('/profile')),
              _NavItem(icon: Icons.settings_outlined, activeIcon: Icons.settings, label: 'Settings', 
                      isActive: selectedIndex == 4, onTap: () => context.go('/settings')),
            ],
          ),
        ),
      ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Icon(isActive ? activeIcon : icon, size: WFDims.iconM, 

...
final mentorMessagesProvider = StateNotifierProvider.family<MentorMessagesNotifier, List<MentorMessage>, String>(
  (ref, mentorId) => MentorMessagesNotifier(mentorId, ref.read(apiServiceProvider)),
);

final isTypingProvider = StateProvider.family<bool, String>((ref, mentorId) => false);
...
class _MentorDetailPageState extends ConsumerState<MentorDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final gradient = LinearGradient(
      colors: widget.mentor.color.map((c) => Color(int.parse(c.replaceFirst('#', '0xFF')))).toList(),
        ...
        title: Row(
          children: [
            Container(
              ...
              child: Center(
                child: Text(widget.mentor.avatar, style: const TextStyle(fontSize: 20)),
              ),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(widget.mentor.name, style: WFTextStyles.h4.copyWith(color: WFColors.purple400)),
                  Text(widget.mentor.subtitle, style: WFTextStyles.bodySmall.copyWith(color: WFColors.textTertiary)),
                ],
              ),
            ),
          ],
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                if (index == messages.length && isTyping) {
                  return _TypingIndicator(mentor: widget.mentor, gradient: gradient);
                }
                ...
                Row(
                  children: [
                    ...
                    WFIconButton(
                      ...
                      color: _textController.text.trim().isEmpty ? WFColors.gray500 : WFColors.purple400,
                    ),
                  ],
                ),
              ],
        ...
        children: [
          if (!isUser) ...[
            Container(
              ...
              child: Center(
                child: Text(mentor.avatar, style: const TextStyle(fontSize: 16)),
              ),
            ),
            const SizedBox(width: WFDims.spacingS),
          ],
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Center(
              child: Text(widget.mentor.avatar, style: const TextStyle(fontSize: 16)),
            ),
          ),
          const SizedBox(width: WFDims.spacingS),
          Container(
